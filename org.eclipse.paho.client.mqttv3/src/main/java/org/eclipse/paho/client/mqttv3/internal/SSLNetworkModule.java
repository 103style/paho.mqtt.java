...
public class SSLNetworkModule extends TCPNetworkModule {
     ...
     *
     * @param factory         the {@link SSLSocketFactory} to be used in this
     *                        SSLNetworkModule
    ...
    public void start() throws IOException, MqttException {
        ...
        // SNI support. Should be automatic under some circumstances - not all,
        // apparently
        try {
        ...
        // If default Hostname verification is enabled, use the same method that
        // is used with HTTPS
